...
<form id="recipeFilterForm" action="{{ route('recipes.index') }}" method="GET">
    ...
    <div class="title-container select-none">
        ...
        <small
            class="font-inclusive text-lg xl:text-2xl text-black px-4">
            Filter recipes
        </small>
    ...
    <div class="flex flex-col items-center px-2 gap-2 md:flex-row md:justify-center md:gap-0.5 md:items-center font-inclusive">
        ...
        <div class="flex flex-col w-full max-w-xs items-center gap-1 md:w-1/4 md:px-2 md:py-2">
            ...
            <div class="relative w-full">
                <select wire:model.live="dishCategory"
                        name="dish_category"
                        class="w-full appearance-none rounded-md border border-neutral-300 bg-neutral-50 px-2 py-1 text-base gourmania-focus disabled:cursor-not-allowed disabled:opacity-75 md:px-4 md:py-2 md:text-sm"
                        autocomplete="off"
                >
        ...
        <div class="w-full max-w-xs md:w-1/4  md:py-2">
            <select wire:model.live="cuisine"
                name="cuisine"
                class="w-full appearance-none rounded-md border border-neutral-300 bg-neutral-50 px-2 py-1 text-base disabled:cursor-not-allowed disabled:opacity-75 gourmania-focus md:px-4 md:py-2 md:text-sm"
                autocomplete="off"
            >
