    ...
    <div class="flex flex-col items-center px-2 gap-2 md:flex-row md:justify-center md:gap-0.5 md:items-center font-inclusive">
        ...
        <div class="flex flex-col w-full max-w-xs items-center gap-1 md:w-1/4 md:px-2 md:py-2">
            ...
            <div class="relative w-full">
                <select wire:model.live="dishCategoryID"
                        id="dishCategory"
                        name="dishCategory"
        ...
        <div class="flex flex-col w-full max-w-xs items-center gap-2 md:w-1/4 md:px-2 md:py-2">
            <div class="relative w-full">
                <select wire:model.live ="recipeID"
                    id="dish"
                    name="dish"
                    class="w-full appearance-none rounded-md border border-neutral-300 bg-neutral-50 gourmania-focus px-2 py-1 text-xs disabled:cursor-not-allowed disabled:opacity-75 md:px-4 md:py-2 md:text-sm" x-model="secondValue" :disabled="!firstValue">
