<form wire:submit.prevent="store">
    @section('title',  Route::currentRouteName() == 'recipes.create' ? 'Add Recipe' : 'Edit Recipe')
    ...
    <div class="title-container">
        ...
        <small class="font-inknut uppercase text-lg md:text-xl lg:text-2xl xl:text-3xl text-black px-4">
           {{ Route::currentRouteName() == 'recipes.create' ? 'CREATE RECIPE' : 'EDIT RECIPE' }}
        </small>
        <span class="flex-grow border-s border-8 border-[#AE763E] md:border-[10px] lg:border-[12px]"></span>
    </div>
    ...
    @if(Route::currentRouteName() == 'Add Recipe')
