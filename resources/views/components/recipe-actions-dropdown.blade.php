...
<div x-data="{ isOpen: false, openedWithKeyboard: false }" x-on:keydown.esc.prevent="isOpen = false, openedWithKeyboard = false" class="absolute top-0.5 right-1 font-inclusive z-40">
    ...
    >
        ...
        <ul class="flex flex-col py-1.5" role="none">
            ...
            <li class="flex items-center gap-2 px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 focus-visible:bg-gray-200 cursor-pointer" role="menuitem" tabindex="0">
        ...
        <ul class="flex flex-col py-1.5" role="none">
            <li class="flex items-center gap-2 px-4 py-2 text-sm text-red-700 hover:bg-red-50 focus-visible:bg-red-100 cursor-pointer" role="menuitem" tabindex="0">
